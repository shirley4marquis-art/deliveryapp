    ...
    <section className="mt-6 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-md">
      ...
      {shipment.package_image_url ? (
        <div className="border-b border-slate-200 px-6 py-5">
          <div className="mb-4">
            <h3 className="text-xl font-black text-[#07152f]">Your collected package</h3>
            <p className="mt-1 text-sm leading-6 text-[#50627f]">
              This image was recorded when Royal Runs received the package from the sender.
            </p>
          </div>
          {/* The image URL is generated by the controlled public Supabase package bucket. */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            alt={`Package collected for shipment ${shipment.tracking_number}`}
            className="max-h-[32rem] w-full rounded-xl border border-slate-200 bg-slate-50 object-contain"
            loading="lazy"
